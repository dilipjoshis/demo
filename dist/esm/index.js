...
`,l=r=>{var{size:o,primary:l,disabled:a,text:p,onClick:d}=r,n=t(r,["size","primary","disabled","text","onClick"]);return e.createElement(i,Object.assign({type:"button",onClick:d,primary:l,disabled:a,size:o},n),'"dilip"')},a=o.input`
  height: 40px;
  width: 300px;
  border-radius: 3px;
  border: solid 2px
...
`,s=o=>{var{id:i,disabled:l,label:s,message:c,error:b,success:x,onChange:m,placeholder:u}=o,f=t(o,["id","disabled","label","message","error","success","onChange","placeholder"]);return e.createElement(r,null,e.createElement(p,null,e.createElement(n,{disabled:l,error:b},s)),e.createElement(a,Object.assign({id:i,type:"text",onChange:m,disabled:l,error:b,success:x,placeholder:u},f)),e.createElement(d,null,e.createElement(n,{error:b},c)))};export{l as Button,s as Input};
